          ...
          <div className="hidden lg:block">
            <div className="relative">
              <ImageWithFallback
                ...
                alt="Al-Haramain Islamic Store"
                className="w-full h-[600px] object-cover rounded-2xl shadow-2xl"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent rounded-2xl" />
              <div className={`absolute bottom-8 ${isRTL ? 'right-8' : 'left-8'} text-white max-w-md`}>
                <h2 className="text-3xl mb-4">Welcome Back to Al-Haramain</h2>
                <p className="text-lg opacity-90">
                  Discover premium Islamic products crafted with devotion and authenticity
                </p>
              </div>
            </div>
          </div>
